...
class student:
    ...
    def student(self, name, studentNumber, grade): # You will need to create your own input parameters for all methods
        self.name = str(name)
        self.studentNumber = str(studentNumber)
        self.grade = int(grade)

        pass

    def course(self, courses, grades):
